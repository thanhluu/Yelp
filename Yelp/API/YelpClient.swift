...
let defaultLocation = [37.785771,-122.406165]
...
class YelpClient: BDBOAuth1RequestOperationManager {
    ...
    func search(with term: String, completion: @escaping ([Business]?, Error?) -> ()) -> AFHTTPRequestOperation {
        return search(with: term, sort: nil, categories: nil, deals: nil, distance: maxDistance, completion: completion)
    }
    ...
    func search(with term: String, sort: YelpSortMode?, categories: [String]?, deals: Bool?, distance: Double?, completion: @escaping ([Business]?, Error?) -> ()) -> AFHTTPRequestOperation {
        ...
        var parameters: [String : AnyObject] = ["term": term as AnyObject, "ll": "\(defaultLocation[0]),\(defaultLocation[1])" as AnyObject]
